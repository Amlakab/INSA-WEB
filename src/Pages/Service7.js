      ...
      >
        <Row className="align-items-center">
          <Col md={6}>
            ...
            >
              <h1 style={{ color: themeStyles.primaryColor }}>International Collaboration</h1>
              <p style={{ color: themeStyles.textColor }}>
                International collaboration is another crucial aspect of INSA’s cybersecurity strategy. The agency works
                with international cybersecurity organizations, government agencies, and private technology firms to
                strengthen Ethiopia’s cyber defenses. These collaborations involve sharing threat intelligence,
                participating in global cybersecurity forums, and forming strategic partnerships with leading technology
                companies. By engaging with international stakeholders, INSA ensures that Ethiopia remains aligned with
                global cybersecurity standards and benefits from advancements in cybersecurity technologies.
              </p>
              <p style={{ color: themeStyles.textColor }}>
                Furthermore, INSA takes part in joint cybersecurity exercises and information-sharing networks to enhance
                the nation’s preparedness against large-scale cyber threats. Through these cooperative efforts, Ethiopia
                can strengthen its cybersecurity posture and effectively respond to emerging digital risks. INSA’s
                international collaborations also include capacity-building initiatives, where the agency partners with
                global organizations to provide training and technical assistance to Ethiopian cybersecurity
                professionals.
              </p>
            </motion.div>
          </Col>

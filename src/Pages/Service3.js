      ...
      >
        <Row className="align-items-center">
          <Col md={6}>
            ...
            >
              <h1 style={{ color: themeStyles.primaryColor }}>Incident Response and Management</h1>
              <p style={{ color: themeStyles.textColor }}>
                The Information Network Security Agency (INSA) operates an Incident Response Team (IRT) that specializes
                in responding to cyber incidents and minimizing their impact. The IRT plays a crucial role in managing
                cybersecurity incidents by detecting, analyzing, and containing threats before they escalate. When a cyber
                incident occurs, the team swiftly investigates the attack to determine its nature, scope, and impact.
                They employ advanced forensic techniques to trace the source of the attack, identify vulnerabilities
                exploited by cybercriminals, and recommend immediate countermeasures. The IRT provides technical
                assistance to affected organizations, guiding them through the recovery process to restore compromised
                systems and mitigate further damage.
              </p>
              <p style={{ color: themeStyles.textColor }}>
                Beyond immediate response efforts, the IRT also conducts post-incident analysis to extract lessons from
                security breaches, helping organizations enhance their cybersecurity resilience. The team works closely
                with other national and international cybersecurity bodies to share threat intelligence and coordinate
                responses to large-scale cyber threats. Additionally, INSA provides cybersecurity awareness programs,
                training sessions, and incident response drills to ensure that organizations are well-prepared to handle
                potential cyberattacks. By strengthening Ethiopia’s cyber incident response capabilities, INSA plays a
                vital role in ensuring national cybersecurity and protecting critical infrastructure from evolving digital
                threats.
              </p>
            </motion.div>
          </Col>
          <Col md={6} className="text-center">
            <motion.img
              src={insa10}
              alt="Incident Response and Management"

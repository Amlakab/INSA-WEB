      ...
      >
        <Row className="align-items-center">
          <Col md={6}>
            ...
            >
              <h1 style={{ color: themeStyles.primaryColor }}>Research and Development (R&D)</h1>
              <p style={{ color: themeStyles.textColor }}>
                The Information Network Security Agency (INSA) invests heavily in cybersecurity research and development
                (R&D) to enhance Ethiopia’s cyber resilience. The agency’s R&D department focuses on innovating new
                cybersecurity technologies and researching emerging threats such as AI-driven cyberattacks, quantum
                computing vulnerabilities, and next-generation encryption techniques. By fostering collaboration with
                universities, research institutions, and private technology firms, INSA accelerates the development of
                cutting-edge cybersecurity solutions tailored to Ethiopia’s specific digital landscape.
              </p>
              <p style={{ color: themeStyles.textColor }}>
                The R&D efforts also include the creation of advanced threat detection systems, automated incident
                response mechanisms, and the integration of artificial intelligence in cybersecurity defense strategies.
                By staying ahead of technological advancements, INSA ensures that the country’s cybersecurity
                infrastructure is capable of defending against sophisticated cyber threats. Moreover, the agency supports
                local cybersecurity startups and initiatives, providing funding and mentorship programs to drive
          ...
          <Col md={6} className="text-center">
            <motion.img
              src={insa13}
              alt="Research and Development (R&D)"

    ...
    >
      ...
      {/* News Section */}
        ...
        <Row className="align-items-center">
            ...
            >
                <h1 style={{ color: themeStyles.primaryColor }}>INSA Launches National Cybersecurity Awareness Campaign</h1>
                <p style={{ color: themeStyles.textColor, fontSize: "1.2rem", lineHeight: "1.8" }}>
                The Information Network Security Agency (INSA) has launched a nationwide cybersecurity awareness campaign aimed at educating citizens, businesses, and government institutions on the importance of digital security. The campaign, titled "Secure Ethiopia," focuses on promoting best practices for online safety, data protection, and threat prevention. Through a series of workshops, seminars, and digital content, INSA aims to empower individuals and organizations to safeguard their digital assets against cyber threats. The initiative also includes partnerships with local media outlets, schools, and community organizations to ensure widespread reach and engagement. INSA’s Director General emphasized that cybersecurity is a shared responsibility and called for collective efforts to build a secure digital ecosystem in Ethiopia. The campaign is part of INSA’s broader strategy to enhance national cybersecurity resilience and foster a culture of cyber awareness across the country.
                </p>
            </motion.div>
            </Col>
            <Col md={6} className="text-center">
            <motion.img
                ...
                alt="INSA Cybersecurity Campaign"
                initial={{ x: 100, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
                transition={{ duration: 1 }}
            />

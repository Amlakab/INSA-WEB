    ...
    <Col md={6} className="text-center">
      ...
      >
        ...
        <p style={{ color: themeStyles.textColor, fontSize: "1.2rem", lineHeight: "1.8" }}>
          The Information Network Security Agency (INSA) is leading the charge in educating Ethiopians about the importance of cybersecurity through its nationwide public awareness campaigns. As Ethiopia’s digital landscape expands, the risks of cyberattacks, online fraud, and data breaches have grown significantly. To address these challenges, INSA has launched a series of workshops, training sessions, and educational programs designed to equip citizens, businesses, and government organizations with the knowledge and tools needed to stay safe online. These initiatives cover critical topics such as phishing prevention, password management, secure online transactions, social media safety, and data privacy, offering practical advice to help individuals and organizations protect themselves from cyber threats. INSA also collaborates with schools, universities, and community organizations to educate younger generations about online safety through interactive webinars, online resources, and outreach programs. Additionally, INSA leverages radio, television, and social media to reach a wider audience and spread cybersecurity awareness across the nation. For professionals in critical sectors like banking, healthcare, telecommunications, and government, INSA provides specialized training on cyber risk management, secure infrastructure, and incident response. Through these efforts, INSA is fostering a cyber-aware culture and empowering Ethiopians to take proactive steps in safeguarding their digital lives, ensuring a safer and more resilient digital environment for the nation.
        </p>
      </motion.div>
    </Col>
    <Col md={6} className="text-center">
